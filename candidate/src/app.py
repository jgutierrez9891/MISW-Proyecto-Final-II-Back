...
if(os.path.isdir('/cloudsql/')):
    ...
    if test:
        app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:{rootsqlpass}@0.0.0.0:3306/candidatos'
        app.config['SQLALCHEMY_BINDS'] = {
            "empresas": 'mysql+pymysql://root:{rootsqlpass}@0.0.0.0:3306/empresas'
        }
    else:
